    ...
    db.collection("PetSellerorAdoption_Profile")
      ...
      .then((querySnapshot) => {
        ...
        querySnapshot.forEach((doc) => {
          ...
          const name = (doc.data().PSA_FirstName +" "+ doc.data().PSA_LastName);
            ...
            <div className="container">
              ...
              <div className="rowCard">
                  {filteredOwner.map((doc) => (
                      <div className="pet-card" key={doc.email} onClick={() => navigate("/admin-seller-profile", {state: {filteredOwner, doc}} )}>
                          <a>
